...
<template>
  <section class="page-hero-section relative flex items-center justify-center overflow-hidden">
    <div class="absolute inset-0 z-0 overflow-hidden">
      <div ref="parallaxLayerRef" class="hero-parallax-layer absolute inset-0">
        <div
