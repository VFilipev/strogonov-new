    ...
    <section id="active" class="bg-background py-20">
      <div class="container mx-auto px-6 md:px-8">
        <div class="animate-fade-in mb-12 text-center">
          <h2 class="mb-4 text-4xl font-serif text-primary md:text-5xl">
            Активный отдых
          </h2>
          <p class="mx-auto max-w-2xl text-lg text-muted-foreground">
            Почувствуйте прилив адреналина и испытайте незабываемые эмоции среди
            уральской природы
          </p>
        </div>
        ...
        <div class="grid gap-6 md:grid-cols-3">
          ...
          >
            <div class="relative h-[400px] overflow-hidden">
              ...
              >
                <h3
                  class="mb-2 text-2xl font-semibold transition-transform duration-300 group-hover:-translate-y-1"
                >
                  {{ activity.title }}
                </h3>
                <p
                  class="line-clamp-4 text-white/90 transition-all duration-300 group-hover:-translate-y-1"
                >
