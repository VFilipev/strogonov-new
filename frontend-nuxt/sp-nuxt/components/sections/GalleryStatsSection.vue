...
const editablePlanDescription2 = ref("Уютные домики среди вековых сосен, живописная набережная реки Обвы, зоны для активного отдыха и тихие уголки для уединения — всё расположено так, чтобы ваш отдых стал по-настоящему особенным.");
